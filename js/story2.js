...
squiffy.story.id = '9afbd2ec1b';
squiffy.story.sections = {
	'setvariables': {
		'text': "<p>{start}</p>",
		'attributes': ["SC = 0","PC = 0","not salarawin","not parentswin","not tie","not carkiss","not greetingfail","not antonia","not clothes","not compliment","not samstory","not interrupt","not hisao","not tease","not roof","not samhelp","not tool","not drink2"],
		'passages': {
		},
	},
	'start': {
	...
	'Samstory more': {
		'text': "<p>{if samstory:\nSamstory text blablabla}\n{else:\nNo Samstory text blabalbla}</p>",
		'passages': {
		},
	},
	'ResultA_101': {
	...
	'Interrupt yes': {
		'text': "<p>SALARA: {SC}\nELTERN: {PC}\n<br/>\n{if salarawin: SALARAWIN}\n{if parentswin: PARENTSWIN}\n{if tie: TIE}</p>\n<p>Lara verlangt mehr Punsch zum Ablenken, und wie toll der doch ist, trinkt erste Fuhre auf Ex, und noch mehr und dann wird ihr schlecht, was die Runde abbricht </br></br></br>\nÜbergang zur Fluffrunde und letztlich Dinner</p>",
